    ...
    listingsCollection
        .find( //query object, in this case an empty object to match all documents
            {},
            {
                ...
                projection: { //this is the projection object to specify which fields to include in the result
                    accommodates: 1,
                    number_of_reviews: 1,
        ...
        .then(listings => { //handle the results of the query (promise)
            if (!listings)
                ...
                res.json(listings) //send the formatted listings as a JSON response
            }
        })
}
